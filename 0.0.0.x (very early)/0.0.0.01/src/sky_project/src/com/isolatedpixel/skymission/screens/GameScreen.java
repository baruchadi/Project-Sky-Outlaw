...
public class GameScreen implements Screen, InputProcessor {
	...
	public void render(float delta) {
		...
		l_height.setText(s_height + world.bob.getBounds().height);
		l_speed.setText(s_speed + Player.SPEED);
		l_width.setText(s_width + world.bob.getBounds().width);
	...
	public void show() {
		...
		l_width = new Label(s_width + world.bob.getBounds().width, skin,
				"small");
		l_height = new Label(s_height + world.bob.getBounds().height, skin,
				"small");
