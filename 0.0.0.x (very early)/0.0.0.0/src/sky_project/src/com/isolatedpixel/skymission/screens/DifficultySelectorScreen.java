...
public class DifficultySelectorScreen implements Screen {
	...
	public void show() {
		...
		list = new List(new String[] { "noob", "amateur", "boss" }, skin);
		
		//list.scale(1.5f);
		
		
		bGo = new TextButton("GO!", skin);
		bGo.pad(30);

		bBack = new TextButton("BACK", skin,"small");
		...
		table.add().colspan(3).width(Gdx.graphics.getWidth()).spaceBottom(100).row();
		table.add(list);
		table.add(bGo);
